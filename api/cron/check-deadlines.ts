// Route API pour le cron job de vérification des deadlines
// Appelée automatiquement par Vercel Cron tous les jours à 9h00
...
export default async function handler(req: Request) {
  ...
  try {
    ...
    const edgeFunctionUrl = `${supabaseUrl}/functions/v1/check-deadlines`;
